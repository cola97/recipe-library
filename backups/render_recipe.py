...
def render_storage(data):
    ...
    if refrigerator is not None:
        ...
        rows.append(
            ...
            f'{esc(format_number(refrigerator))} '
            'days'
            '</p>'
        )
...
def build_html(
    ...
    if (
        ...
        quick_facts.append(
            (
                "Active",
                (
                    f'{format_number(recipe["active_time_minutes"])} '
                    f'min'
                )
            )
        )
    ...
    if (
        ...
        quick_facts.append(
            (
                "Total",
                (
                    f'{format_number(recipe["total_time_minutes"])} '
                    f'min'
                )
            )
        )
    ...
    if (
        ...
        quick_facts.append(
            (
                "Energy",
                (
                    f'{format_number(nutrition["energy_kcal"])} '
                    f'kcal'
                )
            )
        )
    ...
    if (
        ...
        quick_facts.append(
            (
                "Protein",
                (
                    f'{format_number(nutrition["protein_g"])} '
                    f'g'
                )
            )
        )
    ...
    # HTML template
    #
    # string.Template is used deliberately so CSS/JS braces
    # do not have to be doubled for a Python f-string.
    # ========================================================
...
(function () {
    ...
    if (
        ...
        servingsMinus.addEventListener(
            "click",
            () => {
